...
RT64_GetTransformPairing and prints rates under BH_PAIRING=1.
...
EDITS = [
    (
        ...
        '#include "xxHash/xxh3.h"\n'
        "\n"
        "// bh: for the transform-pairing counters below.\n"
        "#include <unordered_set>\n",
    ),
    (
        "namespace RT64 {\n    // GameFrame\n",
        "// bh: running totals of the transform pairing, read by the port through the\n"
    ...
    (
        ...
        "        matchScenes(orthographicScenes, prevFrame.orthographicScenes);\n"
        "\n"
        "        // bh: count what failed to pair (tools/patch_rt64_pairing.py).\n"
        "        {\n"
