...
no loaded module::
    ...
    [bh] recomp::start returned -- runtime shut down
    [bh] shutting down: controller
    [bh] shutting down: window
    [bh] ==== CRASH ====
    [bh] ACCESS_VIOLATION (0xC0000005) at 0000019704441630
    [bh] while executing address 0x19704441630
...
MARKER = "bh: the SDL event filter has to come back off"
