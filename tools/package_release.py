...
#
# Settings and saves live in $XDG_DATA_HOME/body-harvest-recomp, or
# ~/.local/share/body-harvest-recomp. Put a file called portable.txt next to this
# script to keep them here instead.
set -euo pipefail
cd "$(dirname "$(readlink -f "${BASH_SOURCE[0]}")")"
exec ./body-harvest-recomp "$@"
"""

NOTES = """Body Harvest: Recompiled -- Linux x86-64
=========================================

Run ./body-harvest-recomp.sh and pick your own Body Harvest (USA) dump in the
...
Settings and saves live in $XDG_DATA_HOME/body-harvest-recomp, or
~/.local/share/body-harvest-recomp. A file called portable.txt beside the
