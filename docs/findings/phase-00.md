...
**Gate:** see the end of this file (updated when the skeleton builds). The survey half — identity,
symbol source, microcode, code layout, saves, existing ports — is complete.
